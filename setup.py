"""
Script to generate the installer for smoek
"""
...
requires = ["Pyomo", "munch", "numpy"]
packages = _find_packages("smoek")

setup(
    name="smoek",
    version="1.0",
    platforms=["any"],
    description="A python library for modeling with compact expressions",
    classifiers=[
